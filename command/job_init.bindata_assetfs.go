...
func commandAssetsConnectShortNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/connect-short.nomad", size: 1071, mode: os.FileMode(436), modTime: time.Unix(1656777059, 0)}
...
func commandAssetsConnectNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/connect.nomad", size: 18126, mode: os.FileMode(436), modTime: time.Unix(1656777059, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func commandAssetsExampleShortNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/example-short.nomad", size: 369, mode: os.FileMode(436), modTime: time.Unix(1656777059, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func commandAssetsExampleNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/example.nomad", size: 16351, mode: os.FileMode(436), modTime: time.Unix(1656777059, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
